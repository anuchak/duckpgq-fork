...
public:
	...
	bool scanOutput(OperatorState &state_p) const;

	bool computeBFS(ExecutionContext &context, OperatorState &lstate) const;

	static void computeBFSnThreadkMorsel(OperatorState &state_p, ExecutionContext &context);
